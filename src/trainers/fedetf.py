...
from src.models.worker import ETFWorker
...
error_dir = 'result_error/fedetf'
weight_change_dir = "result_weight_change/fedetf"
theta_dir = "result_theta/fedetf"
output_dir = "result_output_differ/fedetf"
loss_dir = "result_loss/fedetf"
acc_dir = "result_acc/fedetf"
...
class FedETFTrainer(BaseTrainer):
    """
    Original Scheme
    """
    def __init__(self, options, dataset, another_dataset):
        ...
        worker = ETFWorker(model, self.optimizer, self.optimizer, options)
        super(FedETFTrainer, self).__init__(options, dataset, another_dataset, worker=worker)
