...
class FedAvg5Trainer(BaseTrainer):
    ...
    def train(self):
        ...
        np.save(loss_dir + '/loss_test' + self.dataset + self.model+ '_freeze_200', self.loss_list_test)  #
        np.save(acc_dir + '/acc_test' + self.dataset + self.model+ '_freeze_200', self.acc_list_test)
